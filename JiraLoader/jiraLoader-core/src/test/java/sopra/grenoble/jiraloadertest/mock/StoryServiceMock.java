...
public class StoryServiceMock implements IIssueService {
	...
	@Override
	public BasicIssue createStory(String projectName, String epicName, String versionName, String resume,
			String description, String priority, String componentName) throws JiraGeneralException {
		BasicIssue bi = null;
		try {
