...
public class JiraController {
	...
	@FXML private TextField tfExcelFilePath;
	@FXML private TextField tfJiraUri;

	@FXML private Button btInject;
	@FXML private Button btSelect;
	@FXML private Button btConnect;
	
	@FXML private ChoiceBox<String> cbProjectChooser;
...
//	}
//
//	public void setCbProjectChooser(ChoiceBoxListCell<String> cbProjectChooser) {
